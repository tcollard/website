<template>
  <div>
    <div class="nav-bar-web">
      ...
      <a class="ref" href="#description" id="descriptionNav">{{
        $t("navBar.about")
      }}</a>
      <a class="ref" href="#skills" id="skillsNav">{{ $t("navBar.skills") }}</a>
      <a class="ref" href="#portfolio" id="portfolioNav">{{
        $t("navBar.portfolio")
      }}</a>
      <a class="ref" href="#experience" id="experienceNav">{{
        $t("navBar.experience")
      }}</a>
      <a class="ref" href="#contact" id="contactNav">{{
        $t("navBar.contact")
      }}</a>
    </div>
    ...
    <div class="listItems" @click="changeIcon">
      <a class="menuTitle" href="#description" id="descriptionPhone">{{
        $t("navBar.about")
      }}</a>
      <a class="menuTitle" href="#skills" id="skillsPhone">{{
        $t("navBar.skills")
      }}</a>
      <a class="menuTitle" href="#portfolio" id="portfolioPhone">{{
        $t("navBar.portfolio")
      }}</a>
      <a class="menuTitle" href="#experience" id="experiencePhone">{{
        $t("navBar.experience")
      }}</a>
      <a class="menuTitle" href="#contact" id="contactPhone">{{
        $t("navBar.contact")
      }}</a>
    ...
    <div v-if="this.downloading" class="download">
      ...
      <div class="answer">
        <a
          class="answerText"
          @click="downloadCV"
          href="https://github.com/tcollard/CV/raw/master/THIBAULT%20COLLARD.pdf"
          download
          >{{ $t("utils.yes") }}</a
        >
